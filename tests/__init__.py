...
from aivision.utils import ASSETS, WEIGHTS_DIR, checks

# Constants used in tests
MODEL = WEIGHTS_DIR / "path with spaces" / "aivi26n.pt"  # test spaces in path
CFG = "aivi26n.yaml"
...
MODELS = sorted([*list(TASK2MODEL.values()), "aivi11n-grayscale.pt"])
SOLUTION_ASSETS = {
