...
from aivision.cfg import TASK2CALIBRATIONDATA, TASK2DATA, TASK2MODEL
from aivision.data.utils import check_cls_dataset, check_det_dataset
from aivision.utils import ARM64, ASSETS_URL, DATASETS_DIR, IS_RASPBERRYPI, LINUX, LOGGER, WEIGHTS_DIR, checks
from aivision.utils.downloads import attempt_download_asset, safe_download
...
def cache_weights(slow: bool = False) -> None:
    ...
    if not MODEL.exists():
        ...
        shutil.copy2(WEIGHTS_DIR / "aivi26n.pt", MODEL)
...
def cache_clip_model() -> None:
    ...
    from aivision.nn.text_model import CLIP
