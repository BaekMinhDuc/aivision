...
model_file = "aivi11s.pt"  # Path to model file
...
window_name = "AIVision AIVI Interactive Tracking"  # Output window name

LOGGER.info("🚀 Initializing model...")
if enable_gpu:
    LOGGER.info("Using GPU...")
    model = AIVI(model_file)
    model.to("cuda")
else:
    LOGGER.info("Using CPU...")
    model = AIVI(model_file, task="detect")
