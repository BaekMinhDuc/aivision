...
pub use crate::model::AIVIv8;
pub use crate::ort_backend::{Batch, OrtBackend, OrtConfig, OrtEP, AIVITask};
pub use crate::aivi_result::{Bbox, Embedding, Point2, AIVIResult};
...
pub fn check_font(font: &str) -> rusttype::Font<'static> {
    ...
    let font_path = if font_path_config.exists() {
        ...
        let source_url = "https://aivision.com/assets/Arial.ttf";
