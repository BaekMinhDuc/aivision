...
from aivision.utils import ASSETS, ROOT, YAML
from aivision.utils.checks import check_requirements


class AIVIv8:
    """AIVIv8 object detection model class for handling ONNX inference and visualization.

    This class provides functionality to load a AIVIv8 ONNX model, perform inference on images, and visualize the
    ...
    Examples:
        Initialize AIVIv8 detector and run inference
        >>> detector = AIVIv8("aiviv8n.onnx", "image.jpg", 0.5, 0.5)
        >>> output_image = detector.main()
    """

    def __init__(self, onnx_model: str, input_image: str, confidence_thres: float, iou_thres: float):
        """Initialize an instance of the AIVIv8 class.
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model", type=str, default="aiviv8n.onnx", help="Input your ONNX model.")
    ...
    # Create an instance of the AIVIv8 class with the specified arguments
    detection = AIVIv8(args.model, args.img, args.conf_thres, args.iou_thres)
