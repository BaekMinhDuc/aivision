...
struct Config {
    ...
    std::string model = "aivi26n";       // model name as deployed on the server
...
// Connects to a Triton-served AIVI model (any task / generation) over gRPC and runs
...
// via common/aivi_postprocess.hpp.
class Predictor {
   public:
