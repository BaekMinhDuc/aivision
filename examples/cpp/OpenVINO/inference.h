...
#ifndef AIVI_INFERENCE_H_
#define AIVI_INFERENCE_H_
...
struct Config {
    std::string model_path = "aivi26n.onnx";  // OpenVINO IR (.xml) or ONNX (.onnx)
...
// Loads any AIVI model (IR or ONNX, any task / generation) and runs inference with
...
// with the other examples via common/aivi_postprocess.hpp.
class Predictor {
   public:
