...
struct Config {
    std::string model_path = "aivi26n.onnx";  // grid export (end2end head disabled); cv::dnn cannot run AIVI26 end2end
...
// Loads any AIVI ONNX model with the OpenCV DNN module and runs inference. OpenCV
