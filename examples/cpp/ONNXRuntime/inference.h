...
struct Config {
    std::string model_path = "aivi26n.onnx";
...
// Loads any AIVI ONNX model (any task / generation) and runs inference. The task,
...
class Predictor {
   ...
   private:
    ...
    Ort::Env env_{ORT_LOGGING_LEVEL_WARNING, "aivi"};
