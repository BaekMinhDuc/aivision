...
from aivision.utils import ASSETS, ROOT, YAML, nms, ops


class AIVIv8Seg:
    """AIVIv8 segmentation model for performing instance segmentation using ONNX Runtime.

    This class implements a AIVIv8 instance segmentation model using ONNX Runtime for inference. It handles
    ...
    Examples:
        >>> model = AIVIv8Seg("aiviv8n-seg.onnx", conf=0.25, iou=0.7)
...
if __name__ == "__main__":
    ...
    model = AIVIv8Seg(args.model, args.conf, args.iou)
