"""
AIVision Results, Boxes, Masks, SemanticMask, Keypoints, Probs, and OBB classes for handling inference results.

Usage: See https://docs.aivision.com/modes/predict/
"""
...
from aivision.utils import LOGGER, DataExportMixin, SimpleClass, ops
from aivision.utils.plotting import Annotator, colors, save_one_box
...
class BaseTensor(SimpleClass):
    ...
    def cuda(self):
        ...
        Examples:
            >>> import torch
            >>> from aivision.engine.results import BaseTensor
            >>> data = torch.tensor([[1, 2, 3], [4, 5, 6]])
            >>> base_tensor = BaseTensor(data, orig_shape=(720, 1280))
            >>> gpu_tensor = base_tensor.cuda()
...
class Results(SimpleClass, DataExportMixin):
    ...
    This class provides comprehensive functionality for handling inference results from various AIVision models,
...
class Keypoints(BaseTensor):
    ...
    Examples:
        >>> import torch
        >>> from aivision.engine.results import Keypoints
