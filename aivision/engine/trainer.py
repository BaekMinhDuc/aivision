...
Usage:
    $ aivi mode=train model=aivi26n.pt data=coco8.yaml imgsz=640 epochs=100 batch=16
"""
...
from aivision.cfg import get_cfg, get_save_dir
from aivision.data.utils import check_cls_dataset, check_det_dataset, convert_ndjson_to_aivi_if_needed
from aivision.nn.tasks import load_checkpoint
from aivision.optim import MuSGD
...
from aivision.utils.autobatch import check_train_batch_size
from aivision.utils.checks import check_amp, check_file, check_imgsz, check_model_file_from_stem, print_args
from aivision.utils.dist import ddp_cleanup, generate_ddp_command
from aivision.utils.files import get_latest_run
from aivision.utils.plotting import plot_results
...
class BaseTrainer:
    ...
    This class provides the foundation for training AIVI models, handling the training loop, validation, checkpointing,
    ...
    def __init__(self, cfg=DEFAULT_CFG, overrides=None, _callbacks: dict | None = None):
        ...
        # Model and Dataset
        self.model = check_model_file_from_stem(self.args.model)  # add suffix, i.e. aivi26n -> aivi26n.pt
        ...
        for k, v in self.model.named_parameters():
            ...
            if any(x in k for x in freeze_layer_names):
                ...
                LOGGER.warning(
                    ...
                    "See aivision.engine.trainer for customization of frozen layers."
                )
    ...
    def _do_train(self):
        ...
        while True:
            ...
            # clear if memory utilization > 50%; always clear on MPS due to leak https://github.com/aivision/aivision/issues/22621
        ...
        torch.save(
            {
                ...
                "license": "AGPL-3.0 (https://aivision.com/license)",
    ...
    def get_dataset(self):
        ...
        """
        try:
            self.args.data = convert_ndjson_to_aivi_if_needed(self.args.data)
            ...
            if self.args.task == "classify":
                ...
                if "yaml_file" in data:
                    self.args.data = data["yaml_file"]  # for validating 'aivi train data=url.zip' usage
        except Exception as e:
    ...
    def build_targets(self, preds, targets):
        """Build target tensors for training AIVI model."""
        pass
    ...
    def plot_training_samples(self, batch, ni):
        """Plot training samples during AIVI training."""
        pass

    def plot_training_labels(self):
        """Plot training labels for AIVI model."""
        pass
    ...
    def final_eval(self):
        """Perform final evaluation and validation for the AIVI model."""
        ...
        if resume:
            try:
                ...
                raise FileNotFoundError(
                    ...
                    "i.e. 'aivi train resume model=path/to/last.pt'"
                ) from e
        self.resume = resume
    ...
    def resume_training(self, ckpt):
        """Resume AIVI training from a given checkpoint."""
        if ckpt is None or not self.resume:
            return
        start_epoch = ckpt.get("epoch", -1) + 1
        assert 0 < start_epoch < self.epochs, (
            f"{self.args.model} training to {self.epochs} epochs is finished, nothing to resume.\n"
            f"Start a new training without resuming, i.e. 'aivi train model={self.args.model}'"
        )
    ...
    def build_optimizer(self, model, name="auto", lr=0.001, momentum=0.9, decay=1e-5, iterations=1e5):
        ...
        if name in {"Adam", "Adamax", "AdamW", "NAdam", "RAdam"}:
            ...
            raise NotImplementedError(
                ...
                "Request support for additional optimizers at https://github.com/aivision/aivision."
            )
        ...
        if use_muon:
            ...
            # proto.semseg is the checkpoint parameter name for AIVI26 semantic auxiliary heads.
