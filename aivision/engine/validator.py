...
Usage:
    $ aivi mode=val model=aivi26n.pt data=coco8.yaml imgsz=640

Usage - formats:
    $ aivi mode=val model=aivi26n.pt                 # PyTorch
                          ...
                          aivi26n_imx_model          # Sony IMX
                          aivi26n_rknn_model         # Rockchip RKNN
...
from aivision.nn.autobackend import AutoBackend
from aivision.utils import LOCAL_RANK, LOGGER, RANK, TQDM, callbacks, colorstr, emojis
from aivision.utils.checks import check_imgsz
...
class BaseValidator:
    ...
    Methods:
        ...
        init_metrics: Initialize performance metrics for the AIVI model.
        ...
        get_desc: Get description of the AIVI model.
        on_plot: Register plots for visualization.
        plot_val_samples: Plot validation samples during training.
        plot_predictions: Plot AIVI model predictions on batch images.
    ...
    def init_metrics(self, model):
        """Initialize performance metrics for the AIVI model."""
        pass
    ...
    def get_desc(self):
        """Get description of the AIVI model."""
        pass

    @property
    def metric_keys(self):
        """Return the metric keys used in AIVI training/validation."""
        return []
    ...
    def plot_predictions(self, batch, preds, ni):
        """Plot AIVI model predictions on batch images."""
        pass
