"""
Module provides functionalities for hyperparameter tuning of the AIVision AIVI models for object detection, instance
segmentation, image classification, pose estimation, and multi-object tracking.

Hyperparameter tuning is the process of systematically searching for the optimal set of hyperparameters
that yield the best model performance. This is particularly crucial in deep learning models like AIVI,
where small changes in hyperparameters can lead to significant differences in model accuracy and efficiency.

Examples:
    Tune hyperparameters for AIVI26n on COCO8 at imgsz=640 and epochs=10 for 300 tuning iterations.
...
from aivision.cfg import CFG_INT_KEYS, get_cfg, get_save_dir
from aivision.utils import DEFAULT_CFG, LOGGER, YAML, callbacks, colorstr, remove_colorstr
from aivision.utils.checks import check_requirements
from aivision.utils.patches import torch_load
from aivision.utils.plotting import plot_tune_results


class Tuner:
    """A class for hyperparameter tuning of AIVI models.

    The class evolves AIVI model hyperparameters over a given number of iterations by mutating them according to the
    ...
    def __init__(self, args=DEFAULT_CFG, _callbacks: dict | None = None):
        ...
        mongodb_db = args.pop("mongodb_db", "aivision")
        ...
        LOGGER.info(
            ...
            f"{self.prefix}💡 Learn about tuning at https://docs.aivision.com/guides/hyperparameter-tuning"
        )
    ...
    def __call__(self, iterations: int = 10, cleanup: bool = True):
        ...
        3. Train a AIVI model with the mutated hyperparameters
        ...
        for i in range(start, iterations):
            ...
            for j, (d, dataset) in enumerate(zip(data, dataset_names)):
                ...
                try:
                    ...
                    # Train AIVI model with mutated hyperparameters (run in subprocess to avoid dataloader hang)
                    launch = [
                        __import__("sys").executable,
                        "-m",
                        "aivision.cfg.__init__",
                    ]  # workaround aivi not found
