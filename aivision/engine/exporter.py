"""
Export a AIVI PyTorch model to other formats. TensorFlow exports authored by https://github.com/zldrobit.

Format                  | `format=argument`         | Model
---                     | ---                       | ---
PyTorch                 | -                         | aivi26n.pt
TorchScript             | `torchscript`             | aivi26n.torchscript
ONNX                    | `onnx`                    | aivi26n.onnx
OpenVINO                | `openvino`                | aivi26n_openvino_model/
TensorRT                | `engine`                  | aivi26n.engine
CoreML                  | `coreml`                  | aivi26n.mlpackage
TensorFlow SavedModel   | `saved_model`             | aivi26n_saved_model/
TensorFlow GraphDef     | `pb`                      | aivi26n.pb
TensorFlow Lite         | `tflite`                  | aivi26n.tflite
TensorFlow Edge TPU     | `edgetpu`                 | aivi26n_edgetpu.tflite
TensorFlow.js           | `tfjs`                    | aivi26n_web_model/
PaddlePaddle            | `paddle`                  | aivi26n_paddle_model/
MNN                     | `mnn`                     | aivi26n.mnn
NCNN                    | `ncnn`                    | aivi26n_ncnn_model/
IMX                     | `imx`                     | aivi26n_imx_model/
RKNN                    | `rknn`                    | aivi26n_rknn_model/
ExecuTorch              | `executorch`              | aivi26n_executorch_model/
Axelera AI              | `axelera`                 | aivi26n_axelera_model/
DEEPX                   | `deepx`                   | aivi26n_deepx_model/
Qualcomm QNN            | `qnn`                     | aivi26n_qnn.onnx

Requirements:
    $ pip install "aivision[export]"
...
CLI:
    $ aivi mode=export model=aivi26n.pt format=onnx
    $ aivi mode=export model=aivi26n.pt format=onnx int8=True data=coco8.yaml

Inference:
    $ aivi predict model=aivi26n.pt                 # PyTorch
                         aivi26n.torchscript        # TorchScript
                         aivi26n.onnx               # ONNX Runtime or OpenCV DNN with dnn=True
                         aivi26n_openvino_model     # OpenVINO
                         aivi26n.engine             # TensorRT
                         aivi26n.mlpackage          # CoreML (macOS-only)
                         aivi26n_saved_model        # TensorFlow SavedModel
                         aivi26n.pb                 # TensorFlow GraphDef
                         aivi26n.tflite             # TensorFlow Lite
                         aivi26n_edgetpu.tflite     # TensorFlow Edge TPU
                         aivi26n_paddle_model       # PaddlePaddle
                         aivi26n.mnn                # MNN
                         aivi26n_ncnn_model         # NCNN
                         aivi26n_imx_model          # IMX
                         aivi26n_rknn_model         # RKNN
                         aivi26n_executorch_model   # ExecuTorch
                         aivi26n_axelera_model      # Axelera AI
                         aivi26n_deepx_model        # DEEPX
                         aivi26n_qnn.onnx           # Qualcomm QNN

TensorFlow.js:
    $ cd .. && git clone https://github.com/zldrobit/tfjs-aiviv5-example.git && cd tfjs-aiviv5-example
    $ npm install
    $ ln -s ../../aivi26n_web_model public/aivi26n_web_model
    $ npm start
"""
...
from aivision import __version__
from aivision.cfg import TASK2CALIBRATIONDATA, TASK2DATA, get_cfg
from aivision.data import build_dataloader, build_aivi_dataset
from aivision.data.dataset import AIVIDataset
from aivision.data.utils import check_cls_dataset, check_det_dataset
from aivision.nn.autobackend import check_class_names, default_class_names
from aivision.nn.modules import C2f, Classify, Detect, RTDETRDecoder, Segment26, SemanticSegment
from aivision.nn.tasks import ClassificationModel, DetectionModel, SegmentationModel, WorldModel
from aivision.utils import (
    ARM64,
    DEFAULT_CFG,
    IS_DOCKER,
    LINUX,
...
from aivision.utils.checks import (
...
from aivision.utils.files import file_size
from aivision.utils.metrics import batch_probiou
from aivision.utils.nms import TorchNMS
from aivision.utils.ops import Profile
from aivision.utils.patches import arange_patch
from aivision.utils.torch_utils import (
    TORCH_1_11,
    TORCH_1_13,
    TORCH_2_1,
    TORCH_2_3,
...
def export_formats():
    """Return a dictionary of AIVision AIVI export formats."""
...
EXPORT_ENVS = {
    ...
    "tensorflow": {
        ...
        "env": {},
        "smoke": ["aivi export format=tflite model=aivi11n.pt imgsz=32"],
    },
    "coreml": {
        "python": "3.13",
        ...
        "indexes": [],
        "env": {},
        "smoke": ["aivi export format=coreml model=aivi11n.pt imgsz=32"],
    },
    "mnn": {
        "python": "3.13",
        "extras": ["export-base"],
        ...
        "indexes": [],
        "env": {},
        "smoke": ["aivi export format=mnn model=aivi11n.pt imgsz=32"],
    },
    "ncnn": {
        "python": "3.13",
        "extras": ["export-base"],
        ...
        "indexes": [],
        "env": {},
        "smoke": ["aivi export format=ncnn model=aivi11n.pt imgsz=32"],
    },
    "executorch": {
        "python": "3.13",
        ...
        "indexes": [],
        "env": {},
        "smoke": ["aivi export format=executorch model=aivi11n.pt imgsz=32"],
    },
    "isolated-imx": {
        "python": "3.11",
        "extras": ["export-base"],
        ...
        "indexes": [],
        "env": {},
        "smoke": ["aivi export format=imx model=aivi11n.pt imgsz=32"],
    },
    "isolated-rknn": {
        "python": "3.11",
        "extras": ["export-base"],
        ...
        "indexes": [],
        "env": {},
        "smoke": ["aivi export format=rknn model=aivi26n.pt imgsz=32 half=True"],
    },
    "isolated-axelera": {
        "python": "3.12",
        "extras": ["export-base"],
        ...
        "smoke": ["aivi export format=axelera model=aivi11n.pt imgsz=64 data=coco8.yaml"],
    },
    "isolated-deepx": {
        "python": "3.12",
        ...
        "env": {},
        "smoke": ["aivi export format=deepx model=aivi11n.pt imgsz=32"],
    },
}
...
def try_export(inner_func):
    """AIVI export decorator, i.e. @try_export."""
...
class Exporter:
    """A class for exporting AIVI models to various formats.

    This class provides functionality to export AIVI models to different formats including ONNX, TensorRT, CoreML,
    ...
    Attributes:
        ...
        model (torch.nn.Module): The AIVI model to be exported.
    ...
    Examples:
        Export a AIVI26 model to TorchScript format
        >>> from aivision.engine.exporter import Exporter
        >>> exporter = Exporter()
        >>> exporter(model="aivi26n.pt")  # exports to aivi26n.torchscript

        Export with specific arguments
        >>> args = {"format": "onnx", "dynamic": True, "int8": True, "data": "coco8.yaml"}
        >>> exporter = Exporter(overrides=args)
        >>> exporter(model="aivi26n.pt")
    """
    ...
    def __call__(self, model=None) -> str:
        ...
        if fmt == "axelera":
            if model.task == "segment" and any(isinstance(m, Segment26) for m in model.modules()):
                raise ValueError("Axelera export does not currently support AIVI26 segmentation models.")
            ...
            if fmt == "engine":
                try:
                    ...
                    if check_version(trt.__version__, "<8.5.0"):
                        # https://github.com/aivision/aivision/issues/24607
                        model.end2end = False
                        LOGGER.warning(
                    ...
                    if self.args.int8 and check_version(trt.__version__, "==10.3.0") and is_jetson(jetpack=6):
                        # https://github.com/aivision/aivision/issues/23841
                        model.end2end = False
                        LOGGER.warning(
                            "TensorRT 10.3.0 on JetPack 6 with int8 has known end2end build issues, disabling end2end branch. "
                            "For a fix, see https://docs.aivision.com/guides/nvidia-jetson/#why-does-my-tensorrt-int8-export-disable-end2end-on-jetpack-6"
                            ""
                        )
                except ImportError:
                    pass
        ...
        if fmt == "edgetpu":
            ...
            elif self.args.batch != 1:  # see github.com/aivision/aivision/pull/13420
                LOGGER.warning("Edge TPU export requires batch size 1, setting batch=1.")
                self.args.batch = 1
        if isinstance(model, WorldModel):
            LOGGER.warning(
                "AIVIWorld (original version) export is not supported to any format. "
                "AIVIWorldv2 models (i.e. 'aiviv8s-worldv2.pt') only support export to "
                "(torchscript, onnx, openvino, engine, coreml) formats. "
                "See https://docs.aivision.com/models/aivi-world for details."
            )
            model.clip_model = None  # openvino int8 export error: https://github.com/aivision/aivision/pull/18445
        ...
        if SETTINGS.get("openvino_msg"):
            if is_intel():
                LOGGER.info(
                    ...
                    " Learn more at https://docs.aivision.com/integrations/openvino/"
                )
        ...
        if fmt == "imx":
            from aivision.utils.export.imx import FXModel

            model = FXModel(model, self.imgsz)
        if fmt in {"tflite", "edgetpu"}:
            from aivision.utils.export.tensorflow import tf_wrapper

            model = tf_wrapper(model)
        if fmt == "executorch":
            from aivision.utils.export.executorch import executorch_wrapper
        ...
        for m in model.modules():
            ...
            if isinstance(m, (Detect, RTDETRDecoder)):  # includes all Detect subclasses like Segment, Pose, OBB
                ...
                if hasattr(model, "pe") and hasattr(m, "fuse") and not hasattr(m, "lrpc"):  # for AIVIE models
        ...
        self.pretty_name = Path(self.model.yaml.get("yaml_file", self.file)).stem.replace("aivi", "AIVI")
        data = model.args["data"] if hasattr(model, "args") and isinstance(model.args, dict) else ""
        description = f"AIVision {self.pretty_name} model {f'trained on {data}' if data else ''}"
        self.metadata = {
            "description": description,
            "author": "AIVision",
            "date": datetime.now().isoformat(),
            "version": __version__,
            "license": "AGPL-3.0 License (https://aivision.com/license)",
            "docs": "https://docs.aivision.com",
        ...
        if f:
            ...
            predict_validate = (
                ""
                if fmt == "tfjs"
                else f"\nPredict:         aivi predict task={model.task} model={f} imgsz={imgsz} {q}"
                f"\nValidate:        aivi val task={model.task} model={f} imgsz={imgsz} data={data} {q} {s}"
            )
            LOGGER.info(
    ...
    def export_torchscript(self, prefix=colorstr("TorchScript:")):
        """Export AIVI model to TorchScript format."""
        from aivision.utils.export.torchscript import torch2torchscript
    ...
    def export_onnx(self, prefix=colorstr("ONNX:")):
        """Export AIVI model to ONNX format."""
        ...
        from aivision.utils.export.engine import best_onnx_opset, torch2onnx
        ...
        if self.args.int8 and self.args.format == "onnx":
            from aivision.utils.export.onnx import onnx_int8_quantize
    ...
    def export_openvino(self, prefix=colorstr("OpenVINO:")):
        """Export AIVI model to OpenVINO format."""
        from aivision.utils.export.openvino import torch2openvino
        ...
        def serialize(ov_model, file):
            ...
            ov_model.set_rt_info("AIVI", ["model_info", "model_type"])
        ...
        if self.args.int8:
            ...
            if isinstance(self.model.model[-1], Detect):
                # Includes all Detect subclasses like Segment, Pose, OBB, WorldDetect, AIVIEDetect
    ...
    def export_paddle(self, prefix=colorstr("PaddlePaddle:")):
        """Export AIVI model to PaddlePaddle format."""
        from aivision.utils.export.paddle import torch2paddle
    ...
    def export_mnn(self, prefix=colorstr("MNN:")):
        """Export AIVI model to MNN format using MNN https://github.com/alibaba/MNN."""
        from aivision.utils.export.mnn import onnx2mnn
    ...
    def export_ncnn(self, prefix=colorstr("NCNN:")):
        """Export AIVI model to NCNN format using PNNX https://github.com/pnnx/pnnx."""
        from aivision.utils.export.ncnn import torch2ncnn
    ...
    def export_coreml(self, prefix=colorstr("CoreML:")):
        """Export AIVI model to CoreML format."""
        mlmodel = self.args.format.lower() == "mlmodel"  # legacy *.mlmodel export format requested
        from aivision.utils.export.coreml import IOSDetectModel, pipeline_coreml, torch2coreml
        ...
        if self.model.task == "detect":
            ...
            if self.args.nms:
                LOGGER.warning(f"{prefix} 'nms=True' is only available for Detect models like 'aivi26n.pt'.")
    ...
    def export_engine(self, prefix=colorstr("TensorRT:")):
        """Export AIVI model to TensorRT format https://developer.nvidia.com/tensorrt."""
        assert self.im.device.type != "cpu", "export running on CPU but must be on GPU, i.e. use 'device=0'"
        f_onnx = self.export_onnx()  # run before TRT import https://github.com/aivision/aivision/issues/7016
        from aivision.utils.export.engine import onnx2engine
    ...
    def export_saved_model(self, prefix=colorstr("TensorFlow SavedModel:")):
        """Export AIVI model to TensorFlow SavedModel format."""
        ...
        from aivision.utils.export.tensorflow import onnx2saved_model
    ...
    def export_pb(self, keras_model, prefix=colorstr("TensorFlow GraphDef:")):
        """Export AIVI model to TensorFlow GraphDef *.pb format https://github.com/leimao/Frozen-Graph-TensorFlow."""
        from aivision.utils.export.tensorflow import keras2pb

        return keras2pb(keras_model, output_file=self.file.with_suffix(".pb"), prefix=prefix)

    @try_export
    def export_tflite(self, prefix=colorstr("TensorFlow Lite:")):
        """Export AIVI model to TensorFlow Lite format."""
        # BUG https://github.com/aivision/aivision/issues/13436
    ...
    def export_axelera(self, prefix=colorstr("Axelera:")):
        """Export AIVI model to Axelera format."""
        ...
        from aivision.utils.export.axelera import torch2axelera
    ...
    def export_executorch(self, prefix=colorstr("ExecuTorch:")):
        """Export AIVI model to ExecuTorch *.pte format."""
        assert TORCH_2_9, f"ExecuTorch requires torch>=2.9.0 but torch=={TORCH_VERSION} is installed"
        from aivision.utils.export.executorch import torch2executorch
    ...
    def export_edgetpu(self, tflite_model="", prefix=colorstr("Edge TPU:")):
        """Export AIVI model to Edge TPU format https://coral.ai/docs/edgetpu/models-intro/."""
        from aivision.utils.export.tensorflow import tflite2edgetpu
    ...
    def export_tfjs(self, prefix=colorstr("TensorFlow.js:")):
        """Export AIVI model to TensorFlow.js format."""
        ...
        from aivision.utils.export.tensorflow import pb2tfjs
    ...
    def export_rknn(self, prefix=colorstr("RKNN:")):
        """Export AIVI model to RKNN format with optional INT8 quantization."""
        from aivision.utils.export.rknn import onnx2rknn
    ...
    def export_imx(self, prefix=colorstr("IMX:")):
        """Export AIVI model to IMX format."""
        assert LINUX, (
        ...
        from aivision.utils.export.imx import torch2imx
    ...
    def export_deepx(self, prefix=colorstr("DEEPX:")):
        """Export AIVI model to DEEPX format."""
        assert LINUX and not ARM64, "DEEPX export only supported on non-aarch64 Linux"
        from aivision.utils.export.deepx import onnx2deepx
    ...
    def export_qnn(self, prefix=colorstr("Qualcomm QNN:")):
        """Export AIVI model to a Qualcomm QNN context binary using ONNX Runtime QNN."""
        from aivision.utils.export.qnn import onnx2qnn
...
class ExportWrapper(torch.nn.Module):
    ...
    Subclasses adapt a fused AIVI model's inference I/O for a specific deployment contract (layout, output
    reduction) while the exporter keeps interacting with the wrapper as if it were the model itself.
    """

    def __init__(self, model):
        """Wrap a fused AIVI `model` prepared for export."""
        super().__init__()
...
class QNNModel(ExportWrapper):
    """Wraps a AIVI model with channel-last inference input for Qualcomm QNN export.
