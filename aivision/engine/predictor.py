...
Usage - sources:
    $ aivi mode=predict model=aivi26n.pt source=0                               # webcam
                                                img.jpg                         # image
                                                vid.mp4                         # video
                                                screen                          # screenshot
                                                path/                           # directory
...
Usage - formats:
    $ aivi mode=predict model=aivi26n.pt                 # PyTorch
                              ...
                              aivi26n_executorch_model   # PyTorch Executorch
...
from aivision.data import load_inference_source
from aivision.data.augment import LetterBox
from aivision.nn.autobackend import AutoBackend
from aivision.utils import DEFAULT_CFG, LOGGER, MACOS, WINDOWS, callbacks, colorstr, ops
from aivision.utils.checks import check_imgsz, check_imshow
from aivision.utils.files import increment_path
from aivision.utils.torch_utils import attempt_compile, select_device, smart_inference_mode

STREAM_WARNING = """
Inference results will accumulate in RAM unless `stream=True` is passed, which can cause out-of-memory errors for large
sources or long-running streams and videos. See https://docs.aivision.com/modes/predict/ for help.
...
class BasePredictor:
    ...
    def __call__(self, source=None, model=None, stream: bool = False, *args, **kwargs):
        ...
        Returns:
            (list[aivision.engine.results.Results] | generator): Results objects or generator of Results objects.
        """
        self.stream = stream
        if stream:
    ...
    def stream_inference(self, source=None, model=None, *args, **kwargs):
        ...
        Yields:
            (aivision.engine.results.Results): Results objects.
        """
    ...
    def setup_model(self, model, verbose: bool = True):
        """Initialize AIVI model with given parameters and set it to evaluation mode.
