...
from aivision.data import build_dataloader, build_aivi_dataset, converter
from aivision.engine.validator import BaseValidator
from aivision.utils import LOGGER, RANK, nms, ops
from aivision.utils.checks import check_requirements
from aivision.utils.metrics import ConfusionMatrix, DetMetrics, box_iou
from aivision.utils.plotting import plot_images
...
class DetectionValidator(BaseValidator):
    ...
    Examples:
        ...
        >>> args = dict(model="aivi26n.pt", data="coco8.yaml")
    ...
    def preprocess(self, batch: dict[str, Any]) -> dict[str, Any]:
        """Preprocess batch of images for AIVI validation.
    ...
    def init_metrics(self, model: torch.nn.Module) -> None:
        """Initialize evaluation metrics for AIVI detection validation.
    ...
    def get_desc(self) -> str:
        """Return a formatted string summarizing class metrics of AIVI model."""
    ...
    def build_dataset(self, img_path: str, mode: str = "val", batch: int | None = None) -> torch.utils.data.Dataset:
        ...
        Returns:
            (Dataset): AIVI dataset.
        """
        return build_aivi_dataset(self.args, img_path, batch, self.data, mode=mode, stride=self.stride)
    ...
    def save_one_txt(self, predn: dict[str, torch.Tensor], save_conf: bool, shape: tuple[int, int], file: Path) -> None:
        """Save AIVI detections to a txt file in normalized coordinates in a specific format.
    ...
    def pred_to_json(self, predn: dict[str, torch.Tensor], pbatch: dict[str, Any]) -> None:
        """Serialize AIVI predictions to COCO json format.
    ...
    def eval_json(self, stats: dict[str, Any]) -> dict[str, Any]:
        """Evaluate AIVI output in JSON format and return performance statistics.
