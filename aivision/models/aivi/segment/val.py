...
from aivision.utils.metrics import SegmentMetrics, mask_iou
...
class SegmentationValidator(DetectionValidator):
    ...
    Examples:
        ...
        >>> args = dict(model="aivi26n-seg.pt", data="coco8-seg.yaml")
    ...
    def preprocess(self, batch: dict[str, Any]) -> dict[str, Any]:
        """Preprocess batch of images for AIVI segmentation validation.
    ...
    def postprocess(self, preds: list[torch.Tensor]) -> list[dict[str, torch.Tensor]]:
        """Post-process AIVI predictions and return output detections with proto.
