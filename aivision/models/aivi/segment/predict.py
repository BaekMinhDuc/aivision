...
from aivision.models.aivi.detect.predict import DetectionPredictor
from aivision.utils import DEFAULT_CFG, ops
...
class SegmentationPredictor(DetectionPredictor):
    ...
    Attributes:
        ...
        model (torch.nn.Module): The loaded AIVI segmentation model.
    ...
    Examples:
        ...
        >>> args = dict(model="aivi26n-seg.pt", source=ASSETS)
    ...
    def postprocess(self, preds, img, orig_imgs):
        ...
        Examples:
            >>> predictor = SegmentationPredictor(overrides=dict(model="aivi26n-seg.pt"))
