...
from aivision.nn.tasks import SegmentationModel
from aivision.utils import DEFAULT_CFG, RANK


class SegmentationTrainer(aivi.detect.DetectionTrainer):
    ...
    Examples:
        ...
        >>> args = dict(model="aivi26n-seg.pt", data="coco8-seg.yaml", epochs=3)
    ...
    def get_model(self, cfg: dict | str | None = None, weights: str | Path | None = None, verbose: bool = True):
        ...
        Examples:
            ...
            >>> model = trainer.get_model(cfg="aivi26n-seg.yaml")
            >>> model = trainer.get_model(weights="aivi26n-seg.pt", verbose=False)
        """
    ...
    def get_validator(self):
        """Return an instance of SegmentationValidator for validation of AIVI model."""
        self.loss_names = "box_loss", "seg_loss", "cls_loss", "dfl_loss", "sem_loss"
        return aivi.segment.SegmentationValidator(
