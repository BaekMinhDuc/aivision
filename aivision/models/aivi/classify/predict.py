...
from aivision.data.augment import classify_transforms
...
class ClassificationPredictor(BasePredictor):
    ...
    Examples:
        ...
        >>> from aivision.models.aivi.classify import ClassificationPredictor
        >>> args = dict(model="aivi26n-cls.pt", source=ASSETS)
