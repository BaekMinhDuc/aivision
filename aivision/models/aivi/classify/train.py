...
from aivision.data import ClassificationDataset, build_dataloader
from aivision.engine.trainer import BaseTrainer
from aivision.models import aivi
from aivision.nn.tasks import ClassificationModel
from aivision.utils import DEFAULT_CFG, LOGGER, RANK
from aivision.utils.plotting import plot_images
from aivision.utils.torch_utils import is_parallel, torch_distributed_zero_first


class ClassificationTrainer(BaseTrainer):
    """A trainer class extending BaseTrainer for training image classification models.

    This trainer handles the training process for image classification tasks, supporting both AIVI classification models
    ...
    Examples:
        ...
        >>> from aivision.models.aivi.classify import ClassificationTrainer
        >>> args = dict(model="aivi26n-cls.pt", data="imagenet10", epochs=3)
    ...
    def set_model_attributes(self):
        """Set the AIVI model's class names from the loaded dataset."""
        self.model.names = self.data["names"]

    def get_model(self, cfg=None, weights=None, verbose: bool = True):
        """Return a modified PyTorch model configured for training AIVI classification.
    ...
    def get_dataloader(self, dataset_path: str, batch_size: int = 16, rank: int = 0, mode: str = "train"):
        ...
        if not dataset.samples:
            raise FileNotFoundError(
                ...
                f"See https://docs.aivision.com/datasets/classify for cls dataset format."
            )
    ...
    def get_validator(self):
        ...
        return aivi.classify.ClassificationValidator(
