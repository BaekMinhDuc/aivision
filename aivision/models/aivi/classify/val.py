...
from aivision.utils.metrics import ClassifyMetrics, ConfusionMatrix
...
class ClassificationValidator(BaseValidator):
    ...
    Examples:
        >>> from aivision.models.aivi.classify import ClassificationValidator
        >>> args = dict(model="aivi26n-cls.pt", data="imagenet10")
