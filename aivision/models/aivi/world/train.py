...
from aivision.data import build_aivi_dataset
from aivision.models.aivi.detect import DetectionTrainer
from aivision.nn.tasks import WorldModel
...
class WorldTrainer(DetectionTrainer):
    """A trainer class for fine-tuning AIVI World models on close-set datasets.

    This trainer extends the DetectionTrainer to support training AIVI World models, which combine visual and textual
    ...
    Attributes:
        text_embeddings (dict[str, torch.Tensor] | None): Cached text embeddings for category names to accelerate
            training.
        model (WorldModel): The AIVI World model being trained.
    ...
    Methods:
        ...
        preprocess_batch: Preprocess a batch of images and text for AIVIWorld training.

    Examples:
        Initialize and train a AIVI World model
        >>> from aivision.models.aivi.world import WorldTrainer
        >>> args = dict(model="aiviv8s-world.pt", data="coco8.yaml", epochs=3)
    ...
    def build_dataset(self, img_path: str, mode: str = "train", batch: int | None = None):
        ...
        Returns:
            (Any): AIVI dataset configured for training or validation.
        """
    ...
    def preprocess_batch(self, batch: dict[str, Any]) -> dict[str, Any]:
        """Preprocess a batch of images and text for AIVIWorld training."""
