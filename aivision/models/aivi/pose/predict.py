...
class PosePredictor(DetectionPredictor):
    ...
    Attributes:
        ...
        model (torch.nn.Module): The loaded AIVI pose model with keypoint detection capabilities.
    ...
    Examples:
        ...
        >>> from aivision.models.aivi.pose import PosePredictor
        >>> args = dict(model="aivi26n-pose.pt", source=ASSETS)
