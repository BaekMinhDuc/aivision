...
from aivision.nn.tasks import SemanticSegmentationModel
from aivision.utils import DEFAULT_CFG, LOGGER, RANK
from aivision.utils.plotting import colors, plt_settings


class SemanticSegmentationTrainer(DetectionTrainer):
    """Trainer for AIVI semantic segmentation models.

    This trainer handles semantic segmentation training, including dataset building, model initialization, and
    validation setup.

    Examples:
        >>> from aivision.models.aivi.semantic import SemanticSegmentationTrainer
        >>> args = dict(model="aivi26n-sem.yaml", data="cityscapes8.yaml", epochs=3)
    ...
    def get_validator(self):
        ...
        return aivi.semantic.SemanticSegmentationValidator(
