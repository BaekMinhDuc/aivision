...
from aivision.utils.loss import FocalLoss, VarifocalLoss
from aivision.utils.metrics import bbox_iou
...
class DETRLoss(nn.Module):
    ...
    def _get_loss_class(
        ...
        if self.fl:
            ...
            loss_cls = nn.BCEWithLogitsLoss(reduction="none")(pred_scores, gt_scores).mean(1).sum()  # AIVI CLS loss
