...
This module provides an interface to the Segment Anything Model (SAM) from AIVision, designed for real-time image
...
class SAM(Model):
    ...
    This class provides an interface to the Segment Anything Model (SAM) from AIVision, designed for promptable
    ...
    def task_map(self) -> dict[str, dict[str, type[Predictor]]]:
        ...
        Examples:
            ...
            >>> print(task_map)
            {'segment': {'predictor': <class 'aivision.models.sam.predict.Predictor'>}}
        """
        return {
