...
using SAM. It forms an integral part of the AIVision framework and is designed for high-performance, real-time image
segmentation tasks.
"""
...
from aivision.engine.predictor import BasePredictor
from aivision.engine.results import Results
from aivision.utils import DEFAULT_CFG, LOGGER, ops
from aivision.utils.metrics import box_iou, mask_iou
...
class Predictor(BasePredictor):
    ...
    def setup_model(self, model=None, verbose=True):
        ...
        parameters for image normalization and other AIVision compatibility settings.
        ...
        # AIVision compatibility settings
