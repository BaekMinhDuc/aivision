...
from aivision.data.augment import Compose, Format, v8_transforms
from aivision.models.aivi.detect import DetectionValidator
from aivision.utils import colorstr, ops

__all__ = ("RTDETRValidator",)  # tuple or list


class RTDETRDataset(AIVIDataset):
    """Real-Time DEtection TRansformer (RT-DETR) dataset class extending the base AIVIDataset class.
    ...
    def __init__(self, *args, data=None, **kwargs):
        """Initialize the RTDETRDataset class by inheriting from the AIVIDataset class.

        This constructor sets up a dataset specifically optimized for the RT-DETR (Real-Time DEtection TRansformer)
        model, building upon the base AIVIDataset functionality.

        Args:
            *args (Any): Variable length argument list passed to the parent AIVIDataset class.
            data (dict | None): Dictionary containing dataset information. If None, default values will be used.
            **kwargs (Any): Additional keyword arguments passed to the parent AIVIDataset class.
        """
...
class RTDETRValidator(DetectionValidator):
    ...
    Examples:
        ...
        >>> from aivision.models.rtdetr import RTDETRValidator
