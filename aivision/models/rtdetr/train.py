...
class RTDETRTrainer(DetectionTrainer):
    ...
    This class extends the DetectionTrainer class for AIVI to adapt to the specific features and architecture of
    ...
    Examples:
        >>> from aivision.models.rtdetr.train import RTDETRTrainer
