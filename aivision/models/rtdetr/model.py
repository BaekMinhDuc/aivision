...
from aivision.nn.tasks import RTDETRDetectionModel
...
class RTDETR(Model):
    ...
    Methods:
        task_map: Return a task map for RT-DETR, associating tasks with corresponding AIVision classes.
    ...
    def task_map(self) -> dict:
        """Return a task map for RT-DETR, associating tasks with corresponding AIVision classes.

        Returns:
            (dict): A dictionary mapping task names to AIVision task classes for the RT-DETR model.
        """
        return {
            "detect": {
