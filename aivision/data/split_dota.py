...
from aivision.data.utils import exif_size, img2label_paths
from aivision.utils import TQDM
...
def load_aivi_dota(data_root: str, split: str = "train") -> list[dict[str, Any]]:
...
def split_images_and_labels(
    ...
    annos = load_aivi_dota(data_root, split=split)
