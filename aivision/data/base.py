...
from aivision.data.utils import FORMATS_HELP_MSG, HELP_URL, IMG_FORMATS, check_file_speeds
from aivision.utils import DEFAULT_CFG, LOCAL_RANK, LOGGER, NUM_THREADS, TQDM
...
class BaseDataset(Dataset):
    ...
    def get_image_and_label(self, index: int) -> dict[str, Any]:
        ...
        """
        label = deepcopy(self.labels[index])  # requires deepcopy() https://github.com/aivision/aivision/pull/1948
