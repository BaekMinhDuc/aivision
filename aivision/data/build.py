...
from aivision.cfg import IterableSimpleNamespace
from aivision.data.dataset import (
    GroundingDataset,
...
from aivision.data.loaders import (
    LOADERS,
    LoadImagesAndVideos,
    LoadPilAndNumpy,
    LoadScreenshots,
...
from aivision.data.utils import IMG_FORMATS, VID_FORMATS
from aivision.utils import RANK, colorstr
from aivision.utils.checks import check_file
from aivision.utils.torch_utils import TORCH_2_0
...
def build_aivi_dataset(
    ...
    """Build and return a AIVI dataset based on configuration parameters."""
...
def check_source(
    ...
    if isinstance(source, (str, int, Path)):  # int for local usb camera
        ...
        raise TypeError("Unsupported image type. For supported types see https://docs.aivision.com/modes/predict")
