...
class BOTrack(STrack):
    """An extended version of the STrack class for AIVI, adding object tracking features.
...
class BOTSORT(BYTETracker):
    """An extended version of the BYTETracker class for AIVI, designed for object tracking with ReID and GMC algorithm.
    ...
    Notes:
        The class is designed to work with a AIVI object detection model and supports ReID only if enabled via args.
    """
