...
def on_predict_start(predictor: object, persist: bool = False) -> None:
    ...
    Args:
        predictor (aivision.engine.predictor.BasePredictor): The predictor object to initialize trackers for.
    ...
    if cfg.tracker_type in {"botsort", "tracktrack", "deepocsort"} and cfg.with_reid and cfg.model == "auto":
        from aivision.nn.modules.head import Detect
...
def register_tracker(model: object, persist: bool) -> None:
    ...
    Examples:
        Register tracking callbacks to a AIVI model
        >>> model = AIVIModel()
