...
class AIGym(BaseSolution):
    ...
    This class extends BaseSolution to monitor workouts using AIVI pose estimation models. It tracks and counts
    ...
    Examples:
        >>> gym = AIGym(model="aivi26n-pose.pt")
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        Args:
            **kwargs (Any): Keyword arguments passed to the parent class constructor including:
                - model (str): Model name or path, defaults to "aivi26n-pose.pt".
        """
        kwargs["model"] = kwargs.get("model", "aivi26n-pose.pt")
    ...
    def process(self, im0) -> SolutionResults:
        """Monitor workouts using AIVision AIVI Pose Model.

        This function processes an input image to track and analyze human poses for workout monitoring. It uses the AIVI
