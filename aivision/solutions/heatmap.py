...
from aivision.solutions.object_counter import ObjectCounter
from aivision.solutions.solutions import SolutionAnnotator, SolutionResults
...
class Heatmap(ObjectCounter):
    ...
    Examples:
        >>> from aivision.solutions import Heatmap
        >>> heatmap = Heatmap(model="aivi26n.pt", colormap=cv2.COLORMAP_JET)
    ...
    def process(self, im0: np.ndarray) -> SolutionResults:
        """Generate heatmap for each frame using AIVision tracking.
