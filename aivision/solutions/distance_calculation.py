...
class DistanceCalculation(BaseSolution):
    ...
    them in a video stream using AIVI object detection and tracking.
    ...
    def process(self, im0) -> SolutionResults:
        ...
        Examples:
            >>> import numpy as np
            >>> from aivision.solutions import DistanceCalculation
        ...
        if self.CFG.get("show") and self.env_check:
            cv2.setMouseCallback("AIVision Solutions", self.mouse_event_for_distance)
