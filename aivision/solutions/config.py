...
class SolutionConfig:
    """Manages configuration parameters for AIVision Vision AI solutions.

    The SolutionConfig class serves as a centralized configuration container for all the AIVision solution modules:
    https://docs.aivision.com/solutions/#solutions. It leverages Python `dataclass` for clear, type-safe, and
    ...
    Attributes:
        ...
        model (str, optional): Path to the AIVision AIVI model to be used for inference.
    ...
    Examples:
        ...
        >>> cfg = SolutionConfig(model="aivi26n.pt", region=[(0, 0), (100, 0), (100, 100), (0, 100)])
    ...
    def update(self, **kwargs: Any):
        ...
        for key, value in kwargs.items():
            if hasattr(self, key):
                ...
                url = "https://docs.aivision.com/solutions/#solutions-arguments"
