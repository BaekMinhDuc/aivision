...
from aivision.utils import LOGGER
from aivision.utils.checks import check_requirements
from aivision.utils.downloads import GITHUB_ASSETS_STEMS
...
class Inference:
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        """
        check_requirements("streamlit>=1.29.0")  # scope imports for faster aivision package load speeds
        ...
        self.model = None  # AIVI model instance
        ...
        LOGGER.info(f"AIVision Solutions: ✅ {self.temp_dict}")
    ...
    def web_ui(self) -> None:
        ...
        font-family: 'Archivo', sans-serif; margin-bottom:20px;">AIVision AIVI Streamlit Application</h1></div>"""
        ...
        with the power of AIVision AIVI! 🚀</h5></div>"""

        # Set html page configuration and append custom HTML
        self.st.set_page_config(page_title="AIVision Streamlit App", layout="wide")
    ...
    def sidebar(self) -> None:
        ...
        with self.st.sidebar:  # Add AIVision LOGO
            logo = "https://raw.githubusercontent.com/aivision/assets/main/logo/AIVision_Logotype_Original.svg"
    ...
    def source_upload(self) -> None:
        ...
        from aivision.data.utils import IMG_FORMATS, VID_FORMATS  # scope import
        ...
        if self.source == "video":
            ...
            if vid_file is not None:
                ...
                with open("aivision.mp4", "wb") as out:  # Open temporary file as bytes
                    out.write(g.read())  # Read bytes into file
                self.vid_file_name = "aivision.mp4"
    ...
    def configure(self) -> None:
        ...
        M_ORD, T_ORD = (
            ["aivi26n", "aivi26s", "aivi26m", "aivi26l", "aivi26x"],
            [
                "",
                "-seg",
                "-sem",
        ...
        with self.st.spinner("Model is downloading..."):
            ...
            self.model = AIVI(model_path)  # Load the AIVI model
