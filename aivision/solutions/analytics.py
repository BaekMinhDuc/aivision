...
from aivision.solutions.solutions import BaseSolution, SolutionResults  # Import a parent class
from aivision.utils import plt_settings
...
class Analytics(BaseSolution):
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        self.title = "AIVision Solutions"  # window name
