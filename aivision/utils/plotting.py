...
from aivision.utils import IS_COLAB, IS_KAGGLE, LOGGER, TryExcept, ops, plt_settings, threaded
from aivision.utils.checks import check_font, check_version, is_ascii
from aivision.utils.files import increment_path


class Colors:
    """AIVision color palette for visualization and plotting.

    This class provides methods to work with the AIVision color palette, including converting hex color codes to RGB
    values and accessing predefined color schemes for object detection and pose estimation.

    ## AIVision Color Palette
    ...
    !!! note "AIVision Brand Colors"

        For AIVision brand colors see [https://www.aivision.com/brand](https://www.aivision.com/brand).
        Please use the official AIVision colors for all marketing materials.
    ...
    def __init__(self):
        """Initialize the AIVision color palette from a fixed list of hex color codes."""
        hexs = (
            "042AFF",
            "0BDBEB",
            "F3F3F3",
...
class Annotator:
    """AIVision Annotator for train/val mosaics and JPGs and predictions annotations.
...
def save_one_box(
    ...
    Examples:
        >>> from aivision.utils.plotting import save_one_box
        >>> xyxy = [50, 50, 150, 150]
    ...
    if save:
        ...
        # cv2.imwrite(f, crop)  # save BGR, https://github.com/aivision/aiviv5/issues/7007 chroma subsampling issue
