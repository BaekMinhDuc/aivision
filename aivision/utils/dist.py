...
def generate_ddp_file(trainer: BaseTrainer) -> str:
    ...
    Args:
        trainer (aivision.engine.trainer.BaseTrainer): The trainer containing training configuration and arguments.
    ...
    content = f"""
# AIVision Multi-GPU training temp file (should be automatically deleted after use)
...
def generate_ddp_command(trainer: BaseTrainer) -> tuple[list[str], str]:
    ...
    Args:
        trainer (aivision.engine.trainer.BaseTrainer): The trainer containing configuration for distributed training.
...
def ddp_cleanup(trainer: BaseTrainer, file: str) -> None:
    ...
    Args:
        trainer (aivision.engine.trainer.BaseTrainer): The trainer used for distributed training.
