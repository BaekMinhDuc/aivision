...
class Profile(contextlib.ContextDecorator):
    """AIVision Profile class for timing code execution.
...
def scale_boxes(
    ...
    Args:
        ...
        padding (bool): Whether boxes are based on AIVI-style augmented images with padding.
...
def scale_masks(
    ...
    Args:
        ...
        padding (bool): Whether masks are based on AIVI-style augmented images with padding.
...
def scale_coords(img1_shape, coords, img0_shape, ratio_pad=None, normalize: bool = False, padding: bool = True):
    ...
    Args:
        ...
        padding (bool): Whether coordinates are based on AIVI-style augmented images with padding.
...
def masks2segments(masks: np.ndarray | torch.Tensor, strategy: str = "all") -> list[np.ndarray]:
    ...
    """
    from aivision.data.converter import merge_multi_segment
