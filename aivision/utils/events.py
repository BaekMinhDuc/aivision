...
from aivision import SETTINGS, __version__
from aivision.utils import ARGV, ENVIRONMENT, GIT, IS_PIP_PACKAGE, ONLINE, PYTHON_VERSION, RANK, TESTS_RUNNING
from aivision.utils.downloads import GITHUB_ASSETS_NAMES
...
class Events:
    ...
    def __init__(self) -> None:
        ...
        self.enabled = (
            ...
            and ONLINE
            and (IS_PIP_PACKAGE or GIT.origin == "https://github.com/aivision/aivision.git")
        )
