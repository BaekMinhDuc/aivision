...
from aivision.utils.metrics import CITYSCAPES_WEIGHT, OKS_SIGMA, RLE_WEIGHT
from aivision.utils.ops import crop_mask, xywh2xyxy, xyxy2xywh
from aivision.utils.tal import RotatedTaskAlignedAssigner, TaskAlignedAssigner, dist2bbox, dist2rbox, make_anchors
...
class v8DetectionLoss:
    """Criterion class for computing training losses for AIVIv8 object detection."""
...
class v8SegmentationLoss(v8DetectionLoss):
    """Criterion class for computing training losses for AIVIv8 segmentation."""
...
class v8PoseLoss(v8DetectionLoss):
    """Criterion class for computing training losses for AIVIv8 pose estimation."""
...
class PoseLoss26(v8PoseLoss):
    """Criterion class for computing training losses for AIVI26 pose estimation with RLE loss support."""
...
class v8OBBLoss(v8DetectionLoss):
    """Calculates losses for object detection, classification, and box distribution in rotated AIVI models."""
    ...
    def loss(self, preds: dict[str, torch.Tensor], batch: dict[str, torch.Tensor]) -> tuple[torch.Tensor, torch.Tensor]:
        ...
        try:
            ...
            raise TypeError(
                ...
                "i.e. 'aivi train model=aivi26n-obb.pt data=dota8.yaml'.\nVerify your dataset is a "
                "correctly formatted 'OBB' dataset using 'data=dota8.yaml' "
                "as an example.\nSee https://docs.aivision.com/datasets/obb/ for help."
            ) from e
