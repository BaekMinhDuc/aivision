...
from aivision.cfg import TASK2DATA, TASK2METRIC, get_cfg, get_save_dir
from aivision.utils import DEFAULT_CFG, DEFAULT_CFG_DICT, LOGGER, NUM_THREADS, checks, colorstr
...
def run_ray_tune(
    ...
    **train_args,
    ...
    Args:
        model (AIVI): Model to run the tuner on.
    ...
    Examples:
        ...
        >>> model = AIVI("aivi26n.pt")  # Load a AIVI26n model

        Start tuning hyperparameters for AIVI26n training on the COCO8 dataset
        >>> result_grid = model.tune(data="coco8.yaml", use_ray=True)
    """
    LOGGER.info("💡 Learn about RayTune at https://docs.aivision.com/integrations/ray-tune")
    try:
    ...
    def _tune(config):
        """Train the AIVI model with the specified hyperparameters and return results."""
