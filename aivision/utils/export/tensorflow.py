...
from aivision.nn.modules import Detect, Pose, Pose26
from aivision.utils import LINUX, LOGGER, MACOS
...
from aivision.utils.files import spaces_in_path
...
def onnx2saved_model(
    ...
    check_version(
        ...
        name="tensorflow",
        verbose=True,
        msg="https://github.com/aivision/aivision/issues/5161",
    )
    ...
    keras_model = onnx2tf.convert(
        ...
        verbosity="error",  # note INT8-FP16 activation bug https://github.com/aivision/aivision/issues/15873
