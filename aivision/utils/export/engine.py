...
from aivision.utils import IS_JETSON, LOGGER, TORCH_VERSION, ThreadingLocked, is_dgx, is_jetson
from aivision.utils.checks import check_requirements, check_tensorrt, check_version
from aivision.utils.torch_utils import TORCH_2_4, TORCH_2_9
...
def modelopt_quantize_onnx(
    ...
    Args:
        ...
        dataset (aivision.data.build.InfiniteDataLoader | None): Dataloader providing INT8 calibration images.
...
def onnx2engine(
    ...
    """Export a AIVI model to TensorRT engine format.
    ...
    Args:
        ...
        dataset (aivision.data.build.InfiniteDataLoader, optional): Dataset for INT8 calibration.
    ...
    # https://github.com/aivision/aivision/issues/22873
    ...
    check_version(trt.__version__, "!=10.2.0", msg="https://github.com/aivision/aivision/pull/24367")
    ...
    if int8 and not is_trt11:
        ...
        class EngineCalibrator(trt.IInt8Calibrator):
            ...
            def __init__(
                self,
                dataset,  # aivision.data.build.InfiniteDataLoader
                cache: str = "",
            ) -> None:
