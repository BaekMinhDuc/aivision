...
from aivision.utils.metrics import batch_probiou, box_iou
...
def non_max_suppression(
    ...
    if isinstance(prediction, (list, tuple)):  # AIVIv8 model in validation mode, output = (inference_out, loss_out)
...
class TorchNMS:
    """AIVision custom NMS implementation optimized for AIVI.
