...
from aivision.utils import LOGGER, SETTINGS, TESTS_RUNNING
...
def on_pretrain_routine_start(trainer) -> None:
    ...
    try:
        if task := Task.current_task():
            ...
            task = Task.init(
                project_name=str(trainer.args.project or "AIVision").lstrip("/") or "AIVision",
            ...
            LOGGER.warning(
                ...
                "please add clearml-init and connect your arguments before initializing AIVI."
            )
