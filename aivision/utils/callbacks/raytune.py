...
from aivision.utils import SETTINGS
...
def on_fit_epoch_end(trainer):
    ...
    Args:
        trainer (aivision.engine.trainer.BaseTrainer): The AIVision trainer object containing metrics and epochs.

    Examples:
        >>> # Called automatically by the AIVision training loop
