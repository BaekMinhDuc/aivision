"""Base callbacks for AIVision training, validation, prediction, and export processes."""
...
def get_default_callbacks():
    """Get the default callbacks for AIVision training, validation, prediction, and export processes.
