...
from aivision.utils import LOGGER, SETTINGS, TESTS_RUNNING, colorstr, torch_utils
...
def _log_tensorboard_graph(trainer) -> None:
    ...
    tensor. It first tries a simple method suitable for AIVI models, and if that fails, falls back to a more complex
    approach for models like RTDETR that may require special handling.

    Args:
        trainer (aivision.engine.trainer.BaseTrainer): The trainer object containing the model to visualize. Must
