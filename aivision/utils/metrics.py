...
from aivision.utils import LOGGER, DataExportMixin, SimpleClass, TryExcept, checks, plt_settings
...
def smooth_bce(eps: float = 0.1) -> tuple[float, float]:
    ...
    References:
        https://github.com/aivision/aiviv3/issues/238#issuecomment-598028441
    """
...
class Metric(SimpleClass):
    """Class for computing evaluation metrics for AIVision AIVI models.
    ...
    def __init__(self) -> None:
        """Initialize a Metric instance for computing evaluation metrics for the AIVI model."""
        self.p = []  # (nc, )
        self.r = []  # (nc, )
        self.f1 = []  # (nc, )
        self.all_ap = []  # (nc, 10)
