...
def update_models(model_names: tuple = ("aivi26n.pt",), source_dir: Path = Path("."), update_names: bool = False):
    """Update and re-save specified AIVI models in an 'updated_models' subdirectory.
    ...
    Examples:
        Update specified AIVI models and save them in 'updated_models' subdirectory:
        >>> from aivision.utils.files import update_models
        >>> model_names = ("aivi26n.pt", "aivi11s.pt")
        >>> update_models(model_names, source_dir=Path("/models"), update_names=True)
    """
    from aivision import AIVI
    from aivision.nn.autobackend import default_class_names
