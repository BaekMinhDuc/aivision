...
class QNNBackend(BaseBackend):
    ...
    Loads and runs the QNN context binary produced by the AIVision QNN export (`*_qnn.onnx`) using ONNX Runtime with
    ...
    def load_model(self, weight: str | Path) -> None:
        ...
        from aivision.utils.export.qnn import qnn_library_paths
