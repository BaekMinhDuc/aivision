...
from aivision.utils.torch_utils import fuse_conv_and_bn
...
class Proto(nn.Module):
    """AIVision AIVI models mask Proto module for segmentation models."""

    def __init__(self, c1: int, c_: int = 256, c2: int = 32):
        """Initialize the AIVision AIVI models mask Proto module with specified number of protos and masks.
...
class SPPF(nn.Module):
    """Spatial Pyramid Pooling - Fast (SPPF) layer for AIVIv5 by Glenn Jocher."""
...
class C2fPSA(C2f):
    ...
    Examples:
        >>> import torch
        >>> from aivision.nn.modules.block import C2fPSA
...
class SCDown(nn.Module):
    ...
    Examples:
        >>> import torch
        >>> from aivision.nn.modules.block import SCDown
...
class AAttn(nn.Module):
    """Area-attention module for AIVI models, providing efficient attention mechanisms.
    ...
    def __init__(self, dim: int, num_heads: int, area: int = 1):
        """Initialize an Area-attention module for AIVI models.
...
class ABlock(nn.Module):
    """Area-attention block module for efficient feature extraction in AIVI models.
...
class Proto26(Proto):
    """AIVision AIVI26 models mask Proto module for segmentation models."""
