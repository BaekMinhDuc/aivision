...
HUB_API_ROOT = os.environ.get("AIVISION_HUB_API", "https://api.aivision.com")
HUB_WEB_ROOT = os.environ.get("AIVISION_HUB_WEB", "https://hub.aivision.com")

PREFIX = colorstr("AIVision HUB: ")
HELP_MSG = "If this issue persists please visit https://github.com/aivision/hub/issues for assistance."
